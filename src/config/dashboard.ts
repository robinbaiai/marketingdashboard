...
export const CHAINS: Chain[] = [
  ...
  },
  {
    ...
    segments: [
      {
        name: "上游 · 电解质材料",
        desc: "硫化物/氧化物 · 锂盐",
        query: "A股，固态电池电解质或硫化物电解质或氧化物电解质或锂盐，非ST，非退市，按成交额从高到低排序",
        include: ["固态电池", "电解质", "硫化物", "氧化物", "锂盐", "碳酸锂", "氢氧化锂"],
        exclude: ["整车", "乘用车", "充电桩", "机器人", "光模块", "半导体"],
        stocks: [
          { code: "sz002460", name: "赣锋锂业", tag: "锂盐/固态" },
          { code: "sz002466", name: "天齐锂业", tag: "锂矿" },
          { code: "sh603026", name: "石大胜华", tag: "电解液" },
          { code: "sh603681", name: "永冠新材", tag: "材料" },
        ],
      },
      {
        name: "中游 · 电池与设备",
        desc: "固态电池 · 复合集流体/设备",
        query: "A股，固态电池或复合集流体或锂电设备或电池设备，非ST，非退市，按成交额从高到低排序",
        include: ["固态电池", "复合集流体", "锂电设备", "电池设备", "电池厂商", "动力电池"],
        exclude: ["整车", "乘用车", "充电桩", "机器人", "光模块", "半导体"],
        stocks: [
          ...
          { code: "sz301358", name: "湖南裕能", tag: "正极材料" },
        ],
      },
      {
        name: "下游 · 储能与终端",
        desc: "储能场景 · 电池应用",
        query: "A股，储能或动力电池或固态电池，非ST，非退市，按成交额从高到低排序",
        include: ["储能", "动力电池", "固态电池", "电池应用"],
    ...
    tech: ["硫化物电解质", "氧化物电解质", "复合集流体", "锂金属负极", "干法电极", "大圆柱"],
    keywords: ["固态电池", "电解质", "复合集流体", "锂电", "储能", "动力电池"],
  },
  {
    id: "satellite",
    name: "商业航天星链",
